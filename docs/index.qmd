...
<!--
Buen dia, les habla Ruben mg y a continuación les presentaré
...
- Haciendo introducción al tema, podemos preguntarnos
...
- En lugares concurridos, puede ser complicado encontrar un lugar
  ...
  o incluso conductores habilidosos pueden fallar cuando es necesario una serie de maniobras dependientes.
...
que proporcionan al conductor información sobre el entorno del vehículo.
...
- Si a través de visión computacional lograsemos representar este modelo y evaluarlo, seria suficiente para 
que cualquier algoritmo de aprendizaje por refuerzo pueda aprender a estacionar un vehículo.
:::
...
con respecto al estacionamiento y utilizar este modelo delegar la solución del estacionamiento a un algoritmo de aprendizaje automático. 
:::
...
- Para representar esta posición del vehículo con respecto al estacionamiento,
se propone un sistema de coordenadas con origen en la camara del vehículo.
- donde el eje z representa la altura conocida de la camara con respecto al suelo.
- el eje x representa la orientación de dirección del vehículo.
- y el eje y representa una orientación lateral del vehículo.
:::
...
::: {.notes}
- se utilizara como referencia 4 puntos ubicaos en las esquinas del estacionamiento
:::
...
- $\rho$ : Distancia entre la cámara y un punto de referencia.
- $\theta$: Ángulo de orientación del vehículo.
...
::: {.notes}
- Para representar esta posición del vehículo con respecto al estacionamiento,
se propone un sistema de coordenadas cilíndricas de 4 vectores 
- donde $\rho$ 1 2 3 4 seran las distancias entre la cámara y los puntos de referencia.
- $\theta$ 1 2 3 4 seran los ángulos de orientación entre estos vectores distancia y el eje x.
- y z sera la altura conocida de la camara.
:::
...
::: {.incremental}
  ...
  - <img class="my-h" src="/img/distancesgood.png" alt=""/>
<img class="my-h" src="/img/distancesbad.png" alt=""/>
