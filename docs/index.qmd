...
- Es importante porque permite a los conductores dejar sus vehículos de forma segura en estos espacios
...
podemos procesarlos para detectar la retícula del estacionamiento
:::
...
de 2 dimensiones como el lente de una camara, se produce una distorsion en la imagen. Esta distorsion
...
::: {.notes}
Dado que las lıneas de los cajones de estacionamiento son paralelas por su geometrıa, forman patrones en
una retıcula de paralelogramos. 
:::
...
y para determinarlos se realiza un agrupaiento con el algoritmo de K-means.
:::
...
# Marco Teórico
::: {.notes}
entonces Como parte del marco teorico de la investigacion definimos
:::
